...
enrolling: false,
  ...
  methods: {
    ...
    try {
        ...
        const url = `https://api.jeevandaan.online/api/partners/nearby/?lat=${lat}&lng=${lng}&radius=20`
...
async saveGPSLocation() {
    ...
    navigator.geolocation.getCurrentPosition(
        async (pos) => {
            try {
                await api.post('https://api.jeevandaan.online/api/users/update-location/', {
...
getStockLabel(partner) {
    ...
    async fetchProfile() {
      ...
      try {
        ...
        const response = await fetch('https://api.jeevandaan.online/api/users/profile/', {
          headers: {
    ...
    try {
        ...
        const url = `https://api.jeevandaan.online/api/requests/donor/list/?blood_group=${bg}&lat=${lat}&lon=${lng}`
    ...
    try {
      ...
      const selected = this.partnerRequests.find(r => r.id === requestId)
        const response = await api.post(
            `https://api.jeevandaan.online/api/requests/donor/${requestId}/accept/`
        )
...
goToChat() {
    ...
    try {
        ...
        const response = await api.get(
            `https://api.jeevandaan.online/api/partners/camps/nearby/?lat=${lat}&lng=${lng}`
        )
...
async enrollInCamp() {
    ...
    try {
        await api.post(
            `https://api.jeevandaan.online/api/partners/camps/${this.selectedCamp.id}/enroll/`,
            this.enrollForm
        )
...
// ... enrolled camps ...
  ...
  try {
    const res = await api.get('https://api.jeevandaan.online/api/partners/camps/enrolled/');
  ...
  async cancelEnrollment(campId) {
    ...
    try {
      await api.post(`https://api.jeevandaan.online/api/camps/${campId}/cancel/`, {}, {
...
async submitRating() {
    ...
    try {
        await api.post(
            `https://api.jeevandaan.online/api/requests/attender/${this.ratingForm.reference_id}/rate/`,
            {
...
async fetchMyRequests() {
    ...
    try {
        const response = await api.get('https://api.jeevandaan.online/api/requests/attender/my-requests/')
