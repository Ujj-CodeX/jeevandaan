...
passwordMessage: null,
  ...
  methods: {
    async fetchUserProfile() {
      const res = await api.get('https://api.jeevandaan.online/api/users/profile/', {
    ...
    async submitAadhaar() {
      ...
      try {
        await api.post('https://api.jeevandaan.online/api/users/verify-aadhaar/', { aadhaar_no: this.aadhaarNumber });
    ...
    async updatePassword() {
      ...
      try {
        await api.post('https://api.jeevandaan.online/api/users/change-password/', { password: this.newPassword });
    ...
    try {
        await api.post('https://api.jeevandaan.online/api/users/change-password/', {
...
logout() {
  ...
  try {
    ...
    const res = await api.put('https://api.jeevandaan.online/api/users/update-profile/', payload);
