...
acceptingInterReq: null,
  ...
  methods: {
    ...
    async fetchProfile() {
      ...
      this.error = null
      try {
        const response = await api.get('https://api.jeevandaan.online/api/partners/profile/', 
  )
    ...
    async fetchStock() {
      try {
        const response = await api.get(`https://api.jeevandaan.online/api/stock/partner/${this.partner.id}/`)
    ...
    async buildOverviewStats() {
      try {
        const donorReqs = await api.get('https://api.jeevandaan.online/api/requests/donor/list/')
        const activeDonorReqs = donorReqs.data.filter(r => r.status === 'open').length
        const attenderReqs = await api.get('https://api.jeevandaan.online/api/requests/attender/list/')
        const pendingAttenders = attenderReqs.data.length
        const donations = await api.get('https://api.jeevandaan.online/api/donations/partner-history/')
  ...
  try {
    await api.post(
      'https://api.jeevandaan.online/api/stock/update/',
      {
    ...
    async broadcastDonorRequest() {
      ...
      try {
        await api.post('https://api.jeevandaan.online/api/requests/donor/create/', {
  ...
  try {
    const response = await api.get('https://api.jeevandaan.online/api/requests/donor/detail/')
    ...
    async fetchAttenderRequests() {
      ...
      try {
        const response = await api.get(`https://api.jeevandaan.online/api/requests/attender/list/?city=${this.partner.city}`)
    ...
    async searchByRefId() {
      ...
      try {
        const response = await api.get(`https://api.jeevandaan.online/api/requests/attender/${this.searchRefId}/`)
    ...
    async fulfillAttenderRequest(refId) {
      ...
      try {
        await api.post(`https://api.jeevandaan.online/api/requests/attender/${refId}/fulfill/`)
        this.searchResult = null
        this.searchRefId = ''
    ...
    async verifyOTP() {
      ...
      this.otpError = null
      try {
        const response = await api.post('https://api.jeevandaan.online/api/requests/verify-otp/', { otp_code: this.otpCode })
    ...
    async confirmDonation(requestId) {
      ...
      try {
        await api.post(`https://api.jeevandaan.online/api/donations/verify/${requestId}/`)
    ...
    async fetchRecentDonations() {
      try {
        const response = await api.get('https://api.jeevandaan.online/api/donations/partner-history/')
    ...
    async fetchNotifications() {
      ...
      try {
        const response = await api.get('https://api.jeevandaan.online/api/notifications/partner/')
    ...
    async markNotifRead(notifId) {
      try {
        await api.post(`https://api.jeevandaan.online/api/notifications/${notifId}/read/`)
    ...
    async saveProfile() {
      ...
      try {
        const response = await api.put('https://api.jeevandaan.online/api/partners/profile/', this.profileForm)
    ...
    async savePartnerGPS() {
      ...
      navigator.geolocation.getCurrentPosition(async (pos) => {
        try {
          await api.post('https://api.jeevandaan.online/api/partners/update-location/', { latitude: pos.coords.latitude, longitude: pos.coords.longitude })
        } catch (err) {
...
async createCamp() {
    ...
    try {
        await api.post('https://api.jeevandaan.online/api/partners/camps/create/', this.campForm)
...
async fetchCamps() {
    ...
    try {
        const response = await api.get('https://api.jeevandaan.online/api/partners/camps/')
...
async scheduleAndNotify(campId) {
    ...
    try {
        const response = await api.post(`https://api.jeevandaan.online/api/partners/camps/${campId}/notify/`)
...
async raiseInterPartnerRequest() {
    ...
    try {
        const response = await api.post(
            'https://api.jeevandaan.online/api/partners/inter-request/',
            this.interForm
        )
...
async fetchIncomingInterRequests() {
    ...
    try {
        const response = await api.get('https://api.jeevandaan.online/api/partners/inter-requests/')
...
async acceptInterRequest(reqId) {
    ...
    try {
        await api.post(`https://api.jeevandaan.online/api/partners/inter-requests/${reqId}/accept/`)
...
async downloadEnrollments(camp) {
    ...
    try {
        ...
        const response = await fetch(
            `https://api.jeevandaan.online/api/partners/camps/${camp.id}/download/`,
            {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
